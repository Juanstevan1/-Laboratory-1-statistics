...
Rural absoluto
```{r rend_rural}
(abs<-table(Estudiantes[Estudiantes$Sede=="RURAL",]$Clasificación_Primaria))
```
Rural relativo
```{r rend_rural}
(abs<-table(Estudiantes[Estudiantes$Sede=="RURAL",]$Clasificación_Primaria)/length(Estudiantes[Estudiantes$Sede=="RURAL",]$Clasificación_Primaria))
```
